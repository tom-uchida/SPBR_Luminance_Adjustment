...
//-----
int mainsub_spbr_plybin ( int argc, char** argv )
{
    // Create an application and events
    kvs::glut::Application app( argc, argv );

    // Read the first data file (argv[1])
    SPBR* spbr_engine          = new SPBR( argv[1], PLY_BINARY );//2018/8
    ...
    if ( spbr_engine->isLuminanceAdjustment() ) {
        return mainsub_luminance_adjustment(
                ...
                /* SPBR*                    */  spbr_engine, 
                /* kvs::PointObject*        */  object,
                /* FILE_FORMAT4LA           */  LuminanceAdjustment::PLY_BINARY4LA );
    }
