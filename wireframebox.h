				       ...
				       const kvs::Vector3d& max  = kvs::Vector3d( +1.0, +1.0, +1.0) )
{
  ...
  kvs::Real32 coords[24] = {  
                             static_cast<kvs::Real32>(min.x()), static_cast<kvs::Real32>(min.y()), static_cast<kvs::Real32>(min.z()), // v0
                             static_cast<kvs::Real32>(max.x()), static_cast<kvs::Real32>(min.y()), static_cast<kvs::Real32>(min.z()), // v1
                             static_cast<kvs::Real32>(max.x()), static_cast<kvs::Real32>(max.y()), static_cast<kvs::Real32>(min.z()), // v2
                             static_cast<kvs::Real32>(min.x()), static_cast<kvs::Real32>(max.y()), static_cast<kvs::Real32>(min.z()), // v3  
                             static_cast<kvs::Real32>(min.x()), static_cast<kvs::Real32>(min.y()), static_cast<kvs::Real32>(max.z()), // v4
                             static_cast<kvs::Real32>(max.x()), static_cast<kvs::Real32>(min.y()), static_cast<kvs::Real32>(max.z()), // v5
                             static_cast<kvs::Real32>(max.x()), static_cast<kvs::Real32>(max.y()), static_cast<kvs::Real32>(max.z()), // v6
                             static_cast<kvs::Real32>(min.x()), static_cast<kvs::Real32>(max.y()), static_cast<kvs::Real32>(max.z())
                           }; 
